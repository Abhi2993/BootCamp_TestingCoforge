...
public class ScreenshotExampleTask81 {
    ...
    public void PurchaseProduct() throws Exception {
        ...
        driver.findElement(By.id("loginusername")).sendKeys("Abhinandan2993");
        driver.findElement(By.id("loginpassword")).sendKeys("9555901911");
        ...
        driver.findElement(By.id("name")).sendKeys("Abhinandan");
        driver.findElement(By.id("country")).sendKeys("India");
        driver.findElement(By.id("city")).sendKeys("Varanasi");
